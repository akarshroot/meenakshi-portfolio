            ...
            <div className="p-4 bg-dark slide-in-top">
                ...
                <div className="row">
                    <div className="col-md-6">
                        ...
                        <h1>
                            <a href="https://www.linkedin.com/in/meenakshipanghal/" target="/blank" className="text-white text-decoration-none mx-2">
                                <SiLinkedin className="zoom-on-hover"/>
                            </a> 
                            <a href="https://leetcode.com/meenakshi/" target="/blank" className="text-white text-decoration-none mx-2">
